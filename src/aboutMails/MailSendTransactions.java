...
public class MailSendTransactions {
...
//tabloya verileri çekmek için getValues methodu
	 ...
	 public void start(Stage stage) throws IOException {
		...
		TableView<MailEntity> table = new TableView<MailEntity>();
			...
			//AllParameter Çaðýrýldý
		 AllParameter allParameter=new AllParameter();
			...
			//BUTTON Olaylarý Baþlangýç
	       		//aranan MAÝLLER tabloya geldikten sonra geri çaðýr
				...
				//MAÝL ARAMA ALANI
	       		...
	       		tfSeacrh.setPromptText("NAME | SURNAME | MAÝL ");
			...
			DeleteSendMail deleteMail=new DeleteSendMail();
	       			try {
	       				deleteMail.deleteMail(table,allParameter.gettFWho());
			...
			hboxtop.getChildren().addAll(mail);
			 ...
			 stage.setScene(scene); // scene ekrana eklendi
